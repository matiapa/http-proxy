...
void add_connection(){
    ...
    log(DEBUG,"connections active %d total %lu",global_concurent_connections,global_total_connections);
}
...
void update(int signal_recv){
    ...
    log(DEBUG,"total connections: %lu, current connections :%d, total bytes sent: %lu, total bytes recieved: %lu",
